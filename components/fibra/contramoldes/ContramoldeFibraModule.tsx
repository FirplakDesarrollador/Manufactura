...
import { getRegistrosSinContramolde } from '@/lib/supabase/queries/fibra_contramoldes'
import RegistroContramoldeCard from './RegistroContramoldeCard'
import { Search, Eraser, Info, Database } from 'lucide-react'

export default function ContramoldeFibraModule({ userEmail }: { userEmail: string }) {
