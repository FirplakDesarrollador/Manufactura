...
import { getProductosMS, updateProductosBulk } from '@/lib/supabase/queries/fibra_productos'
import {
    Search,
    Eraser,
    Loader2,
...
export default function ParametrosFibraModule({ userEmail }: { userEmail: string }) {
