...
import { Search, X, Calendar, RefreshCw, Filter, Package } from 'lucide-react'
...
export default function EmpaqueModule({ userEmail, turno, usuarioNombre, plantaMuebles }: EmpaqueModuleProps) {
