...
export default function CulturaPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans relative overflow-x-hidden selection:bg-[#324354] selection:text-white">
      ...
      {/* Main Content */}
      <main className="relative z-10 flex-1 flex items-center justify-center p-3 md:p-5 lg:p-6">
        <div className="w-full max-w-6xl mx-auto flex flex-col gap-3 md:gap-4 animate-fade-in">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch">
            ...
            <div className="lg:col-span-5 flex flex-col gap-3">
              <div className="pl-2">
                <h3 className="text-lg md:text-xl font-light text-[#324354] tracking-wide uppercase font-sans">
                  Nuestro Propósito
                </h3>
                <div className="h-[2.5px] w-10 bg-[#7B8E90] mt-1 rounded-full" />
              </div>
              ...
              <div className="flex flex-col gap-3 flex-1">
                ...
                {/* Purpose Item 1 */}
                <div className="bg-white/80 backdrop-blur-md rounded-xl p-3.5 sm:p-4 border border-[#e2ded5] shadow-[0_4px_20px_rgba(50,67,84,0.02)] hover:shadow-[0_12px_30px_rgba(50,67,84,0.08)] hover:border-[#324354]/20 transition-all duration-300 group flex flex-col gap-2.5">
                  <div className="w-9 h-9 rounded-lg bg-[#324354]/5 flex items-center justify-center text-[#324354] group-hover:bg-[#324354] group-hover:text-white transition-colors duration-300">
            ...
            <div className="lg:col-span-7 flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-2 flex-1 justify-between">
                {[
                  ...
                  <div 
                    key={idx}
                    className="bg-white/80 backdrop-blur-md rounded-xl p-2 sm:p-3 border border-[#e2ded5] shadow-[0_2px_10px_rgba(50,67,84,0.01)] hover:shadow-[0_8px_20px_rgba(50,67,84,0.05)] hover:border-[#324354]/15 hover:translate-x-1.5 transition-all duration-300 flex items-center gap-3 sm:gap-4 group"
                  >
                    {/* Number Badge */}
                    <div className="w-7 h-7 sm:w-9 sm:h-9 shrink-0 rounded-lg bg-[#324354]/5 flex items-center justify-center font-display font-light text-[#324354] text-sm sm:text-base group-hover:bg-[#324354] group-hover:text-[#F6F3EE] transition-colors duration-300 shadow-sm">
                      {idx + 1}
                    </div>
          ...
          <div className="text-center mt-2">
            <p className="text-sm sm:text-base italic text-[#7B8E90] tracking-[0.2em] font-light">
              Inspirando Hogares
            </p>
          </div>
        </div>
