...
export default function MttoHomePage() {
  ...
  return (
    <div className="home-container-centered fade-in" style={{ paddingTop: '2.5rem' }}>
      ...
      {/* Botón para volver al home principal de Manufactura */}
      <div style={{ position: 'absolute', top: '15px', left: '15px' }}>
         <button
            onClick={() => router.push('/sistema-produccion')}
            className="inline-flex items-center justify-center w-10 h-10 bg-white rounded-full hover:bg-gray-100 transition-colors shadow-sm"
         >
