...
const APP_SUMMARIES = [
  ...
  },
  {
    ...
    submodules: [
      ...
      { name: "Gestor de Mantenimiento", desc: "Ordenación de tareas, preventivos programados e historial de fallas." },
