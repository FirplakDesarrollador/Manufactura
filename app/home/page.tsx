                ...
                <div className="w-full max-w-[1800px] grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 md:gap-6 lg:gap-8 justify-items-center mx-auto">
                    ...
                    {hasEstadisticasProduccion() && (
                        ...
                        >
                            ...
                            <span className="text-xl md:text-2xl font-bold text-[#254153] group-hover:text-[#1a2e3b] transition-colors duration-300 text-center">Estadísticas<br/>Sistema</span>
                        </button>
                    )}
                    ...
                    {hasHoraAHora() && (
                        ...
                        >
                            ...
                            <span className="text-xl md:text-2xl font-bold text-[#254153] group-hover:text-[#1a2e3b] transition-colors duration-300">Hora a Hora</span>
                        </button>
                    )}
                    ...
                    {hasFichaRcc() && (
                        ...
                        >
                            ...
                            <span className="text-xl md:text-2xl font-bold text-[#254153] group-hover:text-[#1a2e3b] transition-colors duration-300">Ficha RCC</span>
                        </button>
                    )}
                    ...
                    {hasOpt() && (
                        ...
                        >
                            ...
                            <span className="text-xl md:text-2xl font-bold text-[#254153] group-hover:text-[#1a2e3b] transition-colors duration-300">OPT</span>
                        </button>
                    )}
                    ...
                    {hasTarjetasExcelencia() && (
                        ...
                        >
                            ...
                            <span className="text-xl md:text-2xl font-bold text-[#254153] group-hover:text-[#1a2e3b] transition-colors duration-300 text-center">Tarjetas<br/>Excelencia</span>
                        </button>
                    )}
