                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    {hasApp('muebles') && (
                        ...
                        >
                            ...
                            <span className="text-xl font-bold text-[#254153] group-hover:text-[#1a2e3b] transition-colors duration-200 text-center">Control de piso Muebles</span>
                        </button>
                    )}

                    {/* Fibra Button */}
                    {hasApp('fibra') && (
                        <button onClick={() => router.push('/fibra')} className="flex flex-col items-center justify-center p-10 bg-white rounded-2xl shadow-md border-2 border-gray-100 hover:border-[#254153] hover:shadow-xl transition-all duration-200 group">
                            <div className="w-20 h-20 bg-[#254153]/10 rounded-full flex items-center justify-center mb-5 group-hover:bg-[#254153] transition-all duration-200">
                                <svg className="w-10 h-10 text-[#254153] group-hover:text-white transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                                </svg>
                            </div>
                            <span className="text-xl font-bold text-[#254153] group-hover:text-[#1a2e3b] transition-colors duration-200 text-center">Control de piso Fibra</span>
                        </button>
                    )}
