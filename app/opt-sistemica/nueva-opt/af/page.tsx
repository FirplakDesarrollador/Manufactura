...
const questions = [
  { id: '3.1', text: "Revise si el líder está haciendo el acompañamiento frecuente según la bitácora." },
  { id: '3.2', text: "Pregunte al colaborador cuando fue el ultimo acompañamiento y si recibio correcciones. (Evalué la frecuencia de acompañamiento según los resultados del colaborador y el grupo)" },
  { id: '3.3', text: "Observe la ejecución de la herramienta con la tarjeta. ¿Lo hace correctamente?" },
];
      ...
      <main className="container" style={{ paddingTop: '40px', paddingBottom: '80px' }}>
        <div className="animate-fade-in">
          <h1 style={{ color: 'var(--accent)', fontSize: '2.2rem', fontWeight: 700, marginBottom: '24px' }}>
            🤝 Acompañamiento Frecuente (A/F)
          </h1>

          <div className="card" style={{ marginBottom: '32px', background: 'rgba(118, 149, 152, 0.05)', border: '1px solid var(--primary)' }}>
            <h3 style={{ color: 'var(--primary)', marginBottom: '8px' }}>Módulo de Acompañamiento Frecuente</h3>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            ...
            <div style={{ background: 'white', padding: '32px', borderRadius: '20px', border: '2px solid var(--primary)', marginTop: '20px' }}>
              <div style={{ marginBottom: '32px' }}>
                <label className="label" style={{ fontSize: '1.1rem', fontWeight: 700 }}>% Hora a Hora</label>
              ...
              <div style={{ marginBottom: '32px' }}>
                <label className="label" style={{ fontSize: '1.1rem', fontWeight: 700 }}>PLANES DE ACCIÓN HORA HORA</label>
                <AutoResizeTextarea
              ...
              >
                {saving ? 'Guardando...' : 'Guardar Registro de A/F'}
              </button>
            </div>
          </div>
        </div>
